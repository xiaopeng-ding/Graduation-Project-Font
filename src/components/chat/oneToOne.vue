...
export default {
    ...
    created(){
        ...
        this.mineId = this.$route.params.mineId;
        ...
        //获取要发送的朋友信息
        this.$store.dispatch('findFriend',this.friendName).then(res => {
            // this.friendId = res.data.object.id;
            this.sendMessages.friend.friendId = res.data.object.id;
            this.sendMessages.friend.friendAvatar = res.data.object.avatar;
            this.sendMessages.friend.friendName = this.friendName;
